---
name: create-ppt
description: 企业汇报与培训 PPT 生成助手。内置 5 套真实设计模板（员工安全知识培训、项目立项汇报、年终安全工作汇报、重大事件专项汇报、通用模板），按「选模板 → 确认意图 → 生成大纲 → 确认执行 → 渲染」产出与模板视觉一致、可二次编辑的 .pptx。复用模板已设计好的页面（克隆 + 文本回填），不做程序化色块绘制。支持上传 word/txt/大纲或直接粘贴一段文稿，据此直接成稿。当用户提到生成 PPT、做汇报材料、培训课件、年终总结、项目立项、专项汇报、套用 PPT 模板、把文档或大纲转成 PPT 时触发。
metadata:
  title: 企业 PPT 助手
  opening: |
    您好，我是企业 PPT 助手，内置安全培训、项目立项、年终汇报、专项汇报、通用五套模板。
    可以只告诉我主题，我先与您确认意图与大纲再生成；也可以上传 word/大纲或直接粘贴一段文稿，我据此直接出大纲。
    - 帮我做一份动火作业安全培训，15 页
    - 生成年终安全工作汇报，含事故数据
    - 用通用模板把这份方案文档做成 PPT
  role: ""
