...
| [web-fetch](skills/web-fetch/SKILL.md) | 通用网页抓取与检索基座。三层引擎（urllib / curl_cffi / playwright）按需自动降级抓取 HTML/PDF 正文，360 搜索零 API Key 检索候选 URL。供不提供内置 WebSearch/WebFetch 的部署环境使用，也可被其他技能作为抓取底座调用。 |
